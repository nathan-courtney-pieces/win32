// ispeechsynthesizeroptions.dart
...
/// @nodoc
const IID_ISpeechSynthesizerOptions = '{a0e23871-cc3d-43c9-91b1-ee185324d83d}';

/// {@category Interface}
/// {@category winrt}
class ISpeechSynthesizerOptions extends IInspectable {
  // vtable begins at 6, is 4 entries long.
  ISpeechSynthesizerOptions.fromRawPointer(super.ptr);

  factory ISpeechSynthesizerOptions.from(IInspectable interface) =>
      ISpeechSynthesizerOptions.fromRawPointer(
          interface.toInterface(IID_ISpeechSynthesizerOptions));
