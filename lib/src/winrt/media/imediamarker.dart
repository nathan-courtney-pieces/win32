...
/// @nodoc
const IID_IMediaMarker = '{1803def8-dca5-4b6f-9c20-e3d3c0643625}';
...
class IMediaMarker extends IInspectable {
  ...
  IMediaMarker.fromRawPointer(super.ptr);

  factory IMediaMarker.from(IInspectable interface) =>
      IMediaMarker.fromRawPointer(interface.toInterface(IID_IMediaMarker));
