// imediaplaybacktimedmetadatatracklist.dart
...
/// @nodoc
const IID_IMediaPlaybackTimedMetadataTrackList =
...
class IMediaPlaybackTimedMetadataTrackList extends IInspectable {
  ...
  IMediaPlaybackTimedMetadataTrackList.fromRawPointer(super.ptr);

  factory IMediaPlaybackTimedMetadataTrackList.from(IInspectable interface) =>
      IMediaPlaybackTimedMetadataTrackList.fromRawPointer(
          interface.toInterface(IID_IMediaPlaybackTimedMetadataTrackList));
