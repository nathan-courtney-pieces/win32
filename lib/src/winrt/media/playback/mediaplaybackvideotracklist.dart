// mediaplaybackvideotracklist.dart
...
/// Represents a read-only list of VideoTrack objects, of which a single
...
class MediaPlaybackVideoTrackList extends IInspectable
  ...
  MediaPlaybackVideoTrackList.fromRawPointer(super.ptr);
