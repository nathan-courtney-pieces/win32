...
class IPackage extends IInspectable {
  ...
  IPackage.fromRawPointer(super.ptr);

  factory IPackage.from(IInspectable interface) =>
      IPackage.fromRawPointer(interface.toInterface(IID_IPackage));
  ...
  PackageId? get id {
    ...
    return PackageId.fromRawPointer(retValuePtr);
  }
  ...
  List<Package> get dependencies {
    ...
    final vectorView = IVectorView<Package>.fromRawPointer(retValuePtr,
