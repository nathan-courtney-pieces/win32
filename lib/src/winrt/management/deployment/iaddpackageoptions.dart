...
/// @nodoc
const IID_IAddPackageOptions = '{05cee018-f68f-422b-95a4-66679ec77fc0}';

/// {@category Interface}
/// {@category winrt}
class IAddPackageOptions extends IInspectable {
  // vtable begins at 6, is 30 entries long.
  IAddPackageOptions.fromRawPointer(super.ptr);

  factory IAddPackageOptions.from(IInspectable interface) =>
      IAddPackageOptions.fromRawPointer(
          interface.toInterface(IID_IAddPackageOptions));
